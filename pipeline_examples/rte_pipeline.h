...
void process_pkt(struct rte_pipeline *p, uint16_t port_id, struct rte_mbuf *m);
int rte_pipeline_run_ingress(struct rte_pipeline *p);
int rte_pipeline_run_passthrough(struct rte_pipeline *p);
int rte_pipeline_run_egress(struct rte_pipeline *p);
